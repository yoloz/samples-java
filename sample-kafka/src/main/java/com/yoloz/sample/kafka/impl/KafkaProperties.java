package com.yoloz.sample.kafka.impl;/*
...
//        props.put(SslConfigs.SSL_ENDPOINT_IDENTIFICATION_ALGORITHM_CONFIG,"");
        ...
        props.setProperty(SslConfigs.SSL_TRUSTSTORE_LOCATION_CONFIG, path.resolve("com/yoloz/sample/netty/ssl/user1-truststore.p12").toString());
        props.setProperty(SslConfigs.SSL_TRUSTSTORE_PASSWORD_CONFIG, "123456");
        //*************** If client authentication is required *****************
        if (clientAuth) {
            props.setProperty(SslConfigs.SSL_KEYSTORE_LOCATION_CONFIG, path.resolve("com/yoloz/sample/netty/ssl/user1.p12").toString());
