package com.yoloz.sample.hbase.v_1;
...
public class TableInfoDemo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        java.nio.file.Path path = Paths.get(System.getProperty("user.dir"), "sample-hbase/src/main/resources");
        PropertyConfigurator.configure(com.yoloz.sample.hbase.v_3.TableInfoDemo.class.getResourceAsStream("/log4j.properties"));
